...
import com.suerte.lostandfound.vo.req.ApplyReq;
    ...
    public ModelAndView category(GoodsSearchReq goodsSearchReq, Authentication authentication) {
        ...
        IPage<Goods> page = goodsService.page(new QueryPage<Goods>().getPage(goodsSearchReq),
                new LambdaQueryWrapper<Goods>()
                        ...
                        .notIn(ObjectUtil.isNotEmpty(userApply),Goods::getId,userApply.stream().map(ApplyForm::getGoodsId).collect(Collectors.toList())));
...
//        modelAndView.addObject("categoryList", categoryList);
    ...
    @GetMapping("detail")
    public ModelAndView detail(@RequestParam(value = "id", required = true)
                                       String id,Authentication authentication,HttpServletRequest request) {
...
//        modelAndView.addObject("info",info);
    ...
    @ResponseBody
    public HttpResult applyForMyGoods(@RequestBody ApplyReq applyReq,Authentication authentication) {
